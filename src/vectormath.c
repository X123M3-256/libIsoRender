...
{
	return MATRIX_INDEX(mat, 0, 0)
	    * (MATRIX_INDEX(mat, 1, 1) * MATRIX_INDEX(mat, 2, 2) - MATRIX_INDEX(mat, 1, 2) * MATRIX_INDEX(mat, 2, 1))
	    - MATRIX_INDEX(mat, 0, 1)
	    * (MATRIX_INDEX(mat, 1, 0) * MATRIX_INDEX(mat, 2, 2) - MATRIX_INDEX(mat, 1, 2) * MATRIX_INDEX(mat, 2, 0))
	    + MATRIX_INDEX(mat, 0, 2)
	    * (MATRIX_INDEX(mat, 1, 0) * MATRIX_INDEX(mat, 2, 1) - MATRIX_INDEX(mat, 1, 1) * MATRIX_INDEX(mat, 2, 0));
}
matrix_t matrix_inverse(matrix_t mat)
{
	...
	return matrix(
	    (MATRIX_INDEX(mat, 1, 1) * MATRIX_INDEX(mat, 2, 2) - MATRIX_INDEX(mat, 1, 2) * MATRIX_INDEX(mat, 2, 1))
		/ determinant,
	    (MATRIX_INDEX(mat, 0, 2) * MATRIX_INDEX(mat, 2, 1) - MATRIX_INDEX(mat, 2, 2) * MATRIX_INDEX(mat, 0, 1))
		/ determinant,
	    (MATRIX_INDEX(mat, 0, 1) * MATRIX_INDEX(mat, 1, 2) - MATRIX_INDEX(mat, 1, 1) * MATRIX_INDEX(mat, 0, 2))
		/ determinant,

	    (MATRIX_INDEX(mat, 1, 2) * MATRIX_INDEX(mat, 2, 0) - MATRIX_INDEX(mat, 2, 2) * MATRIX_INDEX(mat, 1, 0))
		/ determinant,
	    (MATRIX_INDEX(mat, 0, 0) * MATRIX_INDEX(mat, 2, 2) - MATRIX_INDEX(mat, 2, 0) * MATRIX_INDEX(mat, 0, 2))
		/ determinant,
	    (MATRIX_INDEX(mat, 0, 2) * MATRIX_INDEX(mat, 1, 0) - MATRIX_INDEX(mat, 1, 2) * MATRIX_INDEX(mat, 0, 0))
		/ determinant,

	    (MATRIX_INDEX(mat, 1, 0) * MATRIX_INDEX(mat, 2, 1) - MATRIX_INDEX(mat, 2, 0) * MATRIX_INDEX(mat, 1, 1))
		/ determinant,
	    (MATRIX_INDEX(mat, 0, 1) * MATRIX_INDEX(mat, 2, 0) - MATRIX_INDEX(mat, 2, 1) * MATRIX_INDEX(mat, 0, 0))
		/ determinant,
	    (MATRIX_INDEX(mat, 0, 0) * MATRIX_INDEX(mat, 1, 1) - MATRIX_INDEX(mat, 1, 0) * MATRIX_INDEX(mat, 0, 1))
		/ determinant);
}
...
{
	return matrix(
	    MATRIX_INDEX(mat, 0, 0), MATRIX_INDEX(mat, 1, 0), MATRIX_INDEX(mat, 2, 0), MATRIX_INDEX(mat, 0, 1),
	    MATRIX_INDEX(mat, 1, 1), MATRIX_INDEX(mat, 2, 1), MATRIX_INDEX(mat, 0, 2), MATRIX_INDEX(mat, 1, 2),
	    MATRIX_INDEX(mat, 2, 2));
}
matrix_t matrix_mult(matrix_t a, matrix_t b)
{
	...
	for (int col = 0; col < 3; col++)
		...
		{
			MATRIX_INDEX(result, row, col) = MATRIX_INDEX(a, row, 0) * MATRIX_INDEX(b, 0, col)
			    + MATRIX_INDEX(a, row, 1) * MATRIX_INDEX(b, 1, col)
			    + MATRIX_INDEX(a, row, 2) * MATRIX_INDEX(b, 2, col);
		}
	return result;
}
